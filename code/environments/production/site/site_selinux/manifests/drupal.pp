...
class site_selinux::drupal {
  ...
  $drupal_selbooleans = lookup('site_selinux::drupal::selbooleans',
                               { 'value_type'    => Hash,
                                 'merge'         => 'deep',
                                 'default_value' => {},
                               })
  ...
  $drupal_file_paths = lookup('site_selinux::drupal::drupal_file_paths',
                              { 'value_type'    => Hash,
                                'merge'         => 'deep',
                                'default_value' => {},
                              })
  ...
  $httpd_readable_paths = lookup('site_selinux::drupal::httpd_readable_paths',
                                 { 'value_type'    => Hash,
                                   'merge'         => 'deep',
                                   'default_value' => {},
                              })
  ...
  $drupal_selinux_modules = lookup('site_selinux::drupal::selinux_modules',
                                   { 'value_type'     => Hash,
                                      'merge'         => 'deep',
                                      'default_value' => {},
                                   })
  ...
  exec { 'semanage-port-8112':
    ...
    unless  => '/bin/grep solr_port_t /etc/selinux/targeted/active/ports.local | /bin/grep -q 8112',
  ...
  exec { 'semanage-port-8114':
    ...
    unless  => '/bin/grep solr_port_t /etc/selinux/targeted/active/ports.local | /bin/grep -q 8114',
    require => Selinux::Module['httpdsolr'],
  }
  ...
  exec { 'semanage-port-8115':
    ...
    unless  => '/bin/grep solr_port_t /etc/selinux/targeted/active/ports.local | /bin/grep -q 8115',
    require => Selinux::Module['httpdsolr'],
  }
}
